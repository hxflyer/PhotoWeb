...
export const createPanelsSlice: StateCreator<EditorStore, [], [], PanelsSlice> = (set) => ({
    ...
    openArbitraryRotationDialog: () => set(state => ({ dialogs: { ...state.dialogs, isArbitraryRotationOpen: true } })),
    openTrimDialog: () => set(state => ({ dialogs: { ...state.dialogs, isTrimOpen: true } })),
    openNewLayerDialog: () => set(state => ({ dialogs: { ...state.dialogs, isNewLayerDialogOpen: true } })),
    ...
    closeArbitraryRotationDialog: () => set(state => ({ dialogs: { ...state.dialogs, isArbitraryRotationOpen: false } })),
    closeTrimDialog: () => set(state => ({ dialogs: { ...state.dialogs, isTrimOpen: false } })),
    closeNewLayerDialog: () => set(state => ({ dialogs: { ...state.dialogs, isNewLayerDialogOpen: false } })),
