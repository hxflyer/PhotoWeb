...
> Source: [https://www.photoshopessentials.com/basics/vector-shapes-vs-pixel-shapes-in-photoshop/](https://www.photoshopessentials.com/basics/vector-shapes-vs-pixel-shapes-in-photoshop/)
> Downloaded and converted to Markdown.

![Vector Shapes vs Pixel Shapes in Photoshop](images/2015-09-featured-b48b942e.gif)

In this first tutorial in our series on drawing and working with shapes in Photoshop, we'll take a quick look at the important difference between the two main types of shapes that we can draw - **vector shapes** and **pixel shapes**.
...
This tutorial is for **Photoshop CC** users. Photoshop CS6 users will want to check out our [Drawing Vector vs Pixel Shapes in Photoshop CS6](/basics/drawing-vector-vs-pixel-shapes-in-photoshop-cs6/) tutorial.
...
![A vector shape on the left and a pixel shape on the right. ](images/shapes-vector-vs-pixel-shapes-two-identical-shapes-79590563.gif)
...
![The Layers panel showing the pixel and vector shapes on separate layers. ](images/shapes-vector-vs-pixel-shapes-layers-panel-9468bc2b.gif)
...
![The shape icon in the lower right of the Shape layer preview thumbnail. ](images/shapes-vector-vs-pixel-shapes-shape-layer-icon-a497720d.gif)
...
![Selecting the vector shape. ](images/shapes-vector-vs-pixel-shapes-select-vector-shape-layer-8f83a11c.gif)
...
![Going to Edit > Fre Transform Path. ](images/shapes-vector-vs-pixel-shapes-edit-freetransformpath-55d0f492.gif)
...
![The Free Transform box appears around the vector shape. ](images/shapes-vector-vs-pixel-shapes-free-transform-path-box-6750896b.gif)
...
![Scaling the vector shape to 10 percent of its original size. ](images/shapes-vector-vs-pixel-shapes-scale-vector-10percent-77cf4117.gif)
...
![The vector shape is now 10 percent the size of the pixel shape. ](images/shapes-vector-vs-pixel-shapes-vector-shape-10percent-9a83b1b6.gif)
...
![Pressing Ctrl+T (Win) / Command+T (Mac) to quickly select Free Transform Path. ](images/shapes-vector-vs-pixel-shapes-freetransformpath-vector-again-265f61e7.gif)
...
![Scaling the vector shape to 1000% of its current size. ](images/shapes-vector-vs-pixel-shapes-scale-vector-1000percent-f09d66f5.gif)
...
![The vector shape retains its crisp, sharp edges even after being scaled. ](images/shapes-vector-vs-pixel-shapes-vector-back-to-original-size-f7f4e0fe.gif)
...
![Selecting the pixel shape layer. ](images/shapes-vector-vs-pixel-shapes-selecting-pixel-shape-a69f4c24.gif)
...
![Selecting Free Transform from under the Edit menu. ](images/shapes-vector-vs-pixel-shapes-edit-freetransform-225f9359.gif)
...
![The Free Transform box appears around the pixel shape. ](images/shapes-vector-vs-pixel-shapes-free-transform-box-aa938586.gif)
...
![Setting the Width and Height of the pixel shape to 10 percent in the Options Bar. ](images/shapes-vector-vs-pixel-shapes-scale-pixel-10percent-ac0edbbb.gif)
...
![The pixel shape is now 10 percent of the size of the vector shape. ](images/shapes-vector-vs-pixel-shapes-pixel-shape-10percent-478fe5f8.gif)
...
![Setting the Width and Height of the pixel shape to 1000 percent in the Options Bar. ](images/shapes-vector-vs-pixel-shapes-scale-pixel-1000percent-748e698b.gif)
...
![A comparison of the vector shape and pixel shape after being scaled up. ](images/shapes-vector-vs-pixel-shapes-vector-shape-vs-pixel-shape-e44aa2d1.gif)
...
![A close-up of the vector and pixel shape edges. ](images/shapes-vector-vs-pixel-shapes-vector-vs-pixel-shape-edges-2b934429.gif)
