...
> Source: [https://www.photoshopessentials.com/basics/type-on-a-path/](https://www.photoshopessentials.com/basics/type-on-a-path/)
> Downloaded and converted to Markdown.

In this tutorial, we'll learn **how to add type along a path** in Photoshop! I'll be using **Photoshop CS6** here but this tutorial is also fully compatible with **Photoshop CC**. If you're using Photoshop CS5 or earlier, you'll want to check out the [previous version](/basics/type-path-photoshop/) of this tutorial.
...
![A golf ball in flight. Image #24403595 licensed from Adobe Stock by Photoshop Essentials.com](images/cs6-type-on-a-path-original-ba2a6cf8.jpg)
*The original image.*
...
As I mentioned, the steps for adding type along a path are the same no matter which tool you used to create the path. So for this tutorial, we'll keep things simple. To draw a path around the golf ball, I'll use the **Ellipse Tool**, one of Photoshop's basic shape tools. You can learn more about drawing shapes in our [How To Draw Vector Shapes in Photoshop](/basics/how-to-draw-vector-shapes-in-photoshop-cs6/) tutorial.
...
![Selecting the Ellipse Tool in Photoshop.](images/cs6-type-on-a-path-photoshop-ellipse-tool-af853a69.png)
*Selecting the Ellipse Tool in the Tools panel.*
...
![The Paths option in the Options Bar in Photoshop.](images/cs6-type-on-a-path-ellipse-tool-mode-option-e6ad31c4.png)
*Changing the mode for the Ellipse Tool to Path.*

**Learn more:** [Drawing Vector Shapes vs Pixel Shapes in Photoshop](/basics/drawing-vector-vs-pixel-shapes-in-photoshop-cs6/)
...
![Drawing a circular path around a golf ball in Photoshop.](images/cs6-type-on-a-path-path-around-ball-27fb5867.jpg)
*A path has been added around the golf ball.*

### Step 4: Select The Type Tool

With our path drawn, we're ready to add our text. Select the **Type Tool** from the Tools panel: 

![Photoshop Type Tool.](images/cs6-type-on-a-path-photoshop-type-tool-5d72d34f.png)
...
![Photoshop font options in the Options Bar.](images/cs6-type-on-a-path-photoshop-font-options-3c840180.png)
...
![The Text Alignment and Color options.](images/cs6-type-on-a-path-text-alignment-color-00eafc71.png)
*The Text Alignment and Color options.*
...
![Photoshop Type Tool cursor showing a dotted wavy line through it.](images/cs6-type-on-a-path-type-tool-path-cursor-4261a176.jpg)
...
![Adding text along a path in Photoshop.](images/cs6-type-on-a-path-adding-text-on-path-4b46ce31.jpg)
*The text is flowing along the shape of the circle.*

When you're done adding your text, click the **checkmark** in the Options Bar to accept it: 

![Clicking the checkmark to accept the text in Photoshop.](images/cs6-type-on-a-path-type-tool-checkmark-f50fb589.png)
...
![The text has been added to the path.](images/cs6-type-on-a-path-type-on-path-97258d69.jpg)
...
![The Path Selection Tool in Photoshop.](images/cs6-type-on-a-path-photoshop-path-selection-tool-942ea958.png)
*Switching to the Path Selection Tool.*
...
![Dragging text along the path in Photoshop.](images/cs6-type-on-a-path-move-text-along-path-e1bf4f43.jpg)
...
![The end of the text is cut off.](images/cs6-type-on-a-path-type-cut-off-7172061c.jpg)
...
![The circle that marks the end of the visible text area.](images/cs6-type-on-a-path-circle-7c1aa8cf.jpg)
...
![Dragging the circle that marks the end of the visible text area along the path.](images/cs6-type-on-a-path-reveal-end-of-text-cdecd4e5.jpg)
*Dragging the circle clockwise along the path to reveal the end of the text that was cut off.*
...
![The text has been flipped to the other side of the path.](images/cs6-type-on-a-path-type-flipped-on-path-ed9dcfb1.jpg)
...
![Selecting the Background layer in Photoshop.](images/cs6-type-on-a-path-select-background-layer-144ed013.png)
...
![Creating type on a path in Photoshop.](images/cs6-type-on-a-path-photoshop-type-on-path-421f3cba.jpg)
*The final result.*
