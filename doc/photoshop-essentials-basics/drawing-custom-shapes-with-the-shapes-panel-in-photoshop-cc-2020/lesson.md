...
> Source: [https://www.photoshopessentials.com/basics/drawing-custom-shapes-with-the-shapes-panel-in-photoshop-cc-2020/](https://www.photoshopessentials.com/basics/drawing-custom-shapes-with-the-shapes-panel-in-photoshop-cc-2020/)
> Downloaded and converted to Markdown.

![How to draw custom shapes in Photoshop](images/2022-04-how-to-draw-custom-shapes-in-photoshop-f-250x250-4297acc3.jpg)
...
Adobe has made lots of improvements to shapes in recent Photoshop versions. So for this tutorial, you’ll want to be using Photoshop 2022 or later. [Get the latest Photoshop version here](https://adobe.prf.hn/click/camref:1100lrdjJ/destination:https%3A%2F%2Fwww.adobe.com%2Fproducts%2Fphotoshop.html "Get Adobe Photoshop").

## Setting up the document

To follow along, all you need is a [new Photoshop document](/basics/create-new-documents-photoshop-cc/ "Learn more").

![A new Photoshop document to draw some custom shapes.](images/2022-draw-custom-shapes-new-photoshop-document-1616f487.jpg)
...
![Selecting the Custom Shape Tool from Photoshop's toolbar](images/2022-draw-custom-shapes-select-custom-shape-tool-photoshop-52eecdc8.png)
...
![Clicking on the current custom shape in Photoshop's Options Bar](images/2022-draw-custom-shapes-current-custom-shape-thumbnail-9eaf7094.png)
...
![The Custom Shape Picker in Photoshop](images/2022-draw-custom-shapes-photoshop-custom-shape-picker-fadf5461.png)
...
![Choosing a shape from the Custom Shape Picker in Photoshop](images/2022-draw-custom-shapes-choose-lion-shape-28eb783c.png)
...
![Setting the Tool Mode for the Custom Shape Tool to Shape in Photoshop's Options Bar](images/2022-draw-custom-shapes-tool-mode-option-shape-ff05aade.png)
...
![Clicking the Fill color swatch to choose a shape color](images/2022-draw-custom-shapes-choose-shape-fill-color-f75c5506.png)
...
![The No Color, Solid Color preset, Gradient preset and Pattern preset fill options for the shape.](images/2022-draw-custom-shapes-fill-color-preset-icons-04b817a9.png)
...
![Clicking the custom color icon.](images/2022-draw-custom-shapes-custom-fill-color-icon-f8a1fa71.png)
...
![Choosing a fill color for the shape from the Color Picker in Photoshop](images/2022-draw-custom-shapes-choose-shape-color-from-color-picker-aa5530cd.jpg)
...
![Clicking the Stroke color swatch for the Custom Shape Tool in Photoshop's Options Bar](images/2022-draw-custom-shapes-stroke-color-swatch-options-bar-a83fe15a.png)
...
![The stroke color options for the Custom Shape Tool in Photoshop](images/2022-draw-custom-shapes-stroke-color-preset-options-d2722ece.png)
...
![The custom color icon for the stroke.](images/2022-draw-custom-shapes-custom-stroke-color-icon-8bd938ba.png)
...
![Entering a size for the stroke that will appear around the custom shape](images/2022-draw-custom-shapes-stroke-size-options-bar-388dd720.png)
...
![The Stroke Options box for the Custom Shape Tool.](images/2022-draw-custom-shapes-stroke-options-box-89718c20.png)
...
![The stroke options include the line type, alignment, cap type and corner type.](images/2022-draw-custom-shapes-stroke-options-panel-ce5fd659.png)
...
![Clicking and dragging to begin drawing the custom shape in Photoshop.](images/2022-draw-custom-shapes-click-and-drag-initial-custom-shape-d74dec11.png)
...
![Holding Shift to draw the custom shape at the proper aspect ratio.](images/2022-draw-custom-shapes-draw-shape-lock-aspect-ratio-6c569091.png)
...
![Hold the spacebar to reposition the custom shape as you draw it.](images/2022-draw-custom-shapes-reposition-shape-while-drawing-7ad0ce40.png)
...
![Release your mouse button to add the fill and stroke to the shape.](images/2022-draw-custom-shapes-release-mouse-button-to-complete-shape-3342ea26.png)
...
![Resizing the custom shape with the transform handles in Photoshop](images/2022-draw-custom-shapes-hold-shift-while-resizing-shape-8a337879.png)
...
![Dragging outside a transform handle to rotate the custom shape.](images/2022-draw-custom-shapes-rotate-shape-ede25006.png)
*Drag outside a transform handle to rotate the shape.*

I’ll rotate my shape back to its original angle.

![Resetting the angle of the custom shape.](images/2022-draw-custom-shapes-rotate-shape-back-to-original-angle-008d450a.png)
*Resetting the angle.*
...
![A custom shape drawn in Photoshop.](images/2022-draw-custom-shapes-shape-drawn-with-custom-shape-tool-50aa1594.png)
*The final shape.*

### The shape layer

In the [Layers panel](/basics/layers/layers-panel/ "Learn more"), the new shape appears on its own shape layer. And since I chose the lion shape, Photoshop named the layer <q>Lion 1</q>.

![Photoshop's Layers panel showing the new shape layer.](images/2022-draw-custom-shapes-new-shape-layer-photoshop-layers-panel-f2d2aad8.png)
...
![Editing the custom shape's fill and stroke in Photoshop's Options Bar](images/2022-draw-custom-shapes-fill-stroke-options-in-options-bar-52ad30ed.png)
...
![The fill, stroke and other shape options in Photoshop's Properties panel.](images/2022-draw-custom-shapes-custom-shape-options-properties-panel-2efdc231.png)
...
![Editing the stroke color in the Properties panel.](images/2022-draw-custom-shapes-click-stroke-color-swatch-properties-panel-e2d6aeaf.png)
...
![Setting the stroke around the custom shape to No Color.](images/2022-draw-custom-shapes-no-color-option-for-stroke-5f9ef93f.png)
*Setting the stroke to No Color.*

And now the stroke is gone, leaving the shape with just its fill color.

![The stroke has been removed from the shape.](images/2022-draw-custom-shapes-custom-shape-fill-no-stroke-4c1b287c.png)
...
![Changing the custom shape's width and height in Photoshop's Properties panel](images/2022-draw-custom-shapes-shape-width-height-options-properties-panel-4a7359ef.png)
*Changing the shape's width and height in the Properties panel.*

And the shape instantly resizes on the canvas.

![The shape has been resized.](images/2022-draw-custom-shapes-shape-resized-from-properties-panel-23f2c020.png)
*The shape at its new size.*

Click the **Flip Horizontal** or **Flip Vertical** icons to flip the shape’s orientation.

![The Flip Horizontal and Flip Vertical options in the Properties panel.](images/2022-draw-custom-shapes-flip-horizontal-vertical-options-35f2a35c.png)
...
![The rotation value for the custom shape in the Properties panel.](images/2022-draw-custom-shapes-shape-angle-option-properties-panel-c7b59012.png)
*The rotation value in the Properties panel.*

Click the arrow to the right of the box to choose from a list of angle presets.

![The preset angles for the custom shape's rotation in Photoshop's Properties panel](images/2022-draw-custom-shapes-angle-preset-options-37f17a62.png)
...
![Selecting the Path Selection Tool in Photoshop's toolbar](images/2022-draw-custom-shapes-select-path-selection-tool-photoshop-d0a2195e.png)
...
![The transform box reappears around the custom shape.](images/2022-draw-custom-shapes-transform-box-around-shape-484f9e03.png)
...
![Holding Shift and dragging a transform handle to resize the custom shape.](images/2022-draw-custom-shapes-resizing-shape-again-44b18349.png)
...
![Repositioning the custom shape with the Path Selection Tool.](images/2022-draw-custom-shapes-how-to-move-the-custom-shape-in-photoshop-fd04a724.png)
...
![Click on the shape with the Path Selection Tool so the path outline is visible.](images/2022-draw-custom-shapes-click-custom-shape-to-select-it-6d2c9473.png)
...
![Clicking the Path Alignment icon in Photoshop's Options Bar.](images/2022-draw-custom-shapes-click-path-alignment-icon-b3e82567.png)
*Clicking the Path Alignment icon.*

In the bottom right of the panel, change **Align To** from Selection to **Canvas**.

![Setting the Align To option to Canvas.](images/2022-draw-custom-shapes-align-to-canvas-option-cb448ca9.png)
...
![Clicking the Align Horizontal Centers and Align Vertical Centers options to center the custom shape on the canvas.](images/2022-draw-custom-shapes-align-horizontal-vertical-centers-options-28a3d546.png)
...
![The custom shape is now centered on the canvas in Photoshop](images/2022-draw-custom-shapes-custom-shape-centered-on-canvas-e515a997.png)
...
![Deleting the shape layer in Photoshop's Layers panel](images/2022-draw-custom-shapes-delete-shape-layer-530be993.png)
...
![Opening the Shapes panel from the Window menu in Photoshop](images/2022-draw-custom-shapes-open-shapes-panel-in-photoshop-434ae97a.png)
...
![The Shapes panel in Photoshop](images/2022-draw-custom-shapes-shapes-panel-opened-6d724585.png)
*The Shapes panel.*
...
![Opening a custom shape group in Photoshop's Shapes panel.](images/2022-draw-custom-shapes-photoshop-shapes-panel-default-shapes-e40a3a17.png)
...
![Clicking the Shapes panel menu icon.](images/2022-draw-custom-shapes-shapes-panel-menu-icon-f00e2a59.png)
*Clicking the Shapes panel menu icon.*

And choose **Small Thumbnail** from the menu.

![Choosing the Small Thumbnail view option in Photoshop's Shapes panel](images/2022-draw-custom-shapes-small-thumbnail-option-shapes-panel-60dc3709.png)
...
![The Recents bar in the Shapes panel](images/2022-draw-custom-shapes-shapes-panel-recents-bar-d3571ea4.png)
*The Recents bar.*
...
![The Show Recents option in the Shapes panel](images/2022-draw-custom-shapes-show-recents-shapes-panel-photoshop-f77396cd.png)
...
![Loading the missing legacy shapes and more in Photoshop](images/2022-draw-custom-shapes-load-legacy-shapes-and-more-photoshop-51f59a9f.png)
*Choosing Legacy Shapes and More.*

A new Legacy Shapes and More group appears below the default groups.

![The Legacy Shapes and More group in the Shapes panel](images/2022-draw-custom-shapes-legacy-shapes-and-more-folder-7fae149b.png)
...
![The 2019 Shapes and All Legacy Default Shapes groups in the Shapes panel](images/2022-draw-custom-shapes-open-legacy-shapes-and-more-group-43cc6aa4.png)
*The 2019 Shapes and All Legacy Default Shapes groups.*
...
![Expanding the Shapes panel to view the 2019 shapes.](images/2022-draw-custom-shapes-2019-shapes-photoshop-f0ed2140.png)
...
![Viewing the legacy shapes in Photoshop](images/2022-draw-custom-shapes-all-legacy-default-shapes-photoshop-e92270f4.png)
...
![The missing shapes are now available in with the Custom Shape Tool.](images/2022-draw-custom-shapes-legacy-shapes-in-custom-shape-picker-fbc6b457.png)
...
![Choosing a custom shape in the Shapes panel in Photoshop](images/2022-draw-custom-shapes-choose-custom-shape-in-shapes-panel-636443f6.png)
...
![Dragging and dropping the shape from the Shapes panel into the document.](images/2022-draw-custom-shapes-drag-and-drop-shape-from-shapes-panel-833756a4.png)
...
![The custom shape added from the Shapes panel in Photoshop](images/2022-draw-custom-shapes-custom-shape-drawn-with-shapes-panel-c80510f0.png)
...
![Resizing the custom shape by dragging the transform handle.](images/2022-draw-custom-shapes-shapes-panel-resize-shape-transform-handles-612804eb.png)
...
![Rotating the shape added from the Shapes panel.](images/2022-draw-custom-shapes-shapes-panel-rotate-custom-shape-7672c6dc.png)
*Rotating the shape.*

To reposition the shape on the canvas, click on the shape and drag it into place. I’ll move mine into the center.

![Dragging the shape to reposition it on the canvas.](images/2022-draw-custom-shapes-shapes-panel-reposition-shape-f8dad5aa.png)
*Dragging the shape to reposition it.*

Then to accept it and close the transform box, click the **checkmark** in the Options Bar.

![Clicking the checkmark to accept the shape.](images/2022-draw-custom-shapes-click-checkmark-to-close-transform-e4dbaf71.png)
*Clicking the checkmark.*

### The shape layer

In the Layers panel, the shape appears on its own shape layer, just as it would if we had drawn it with the Custom Shape Tool. And because I chose a heart shape, Photoshop named the layer <q>Hearts 1</q>.

![Photoshop's Layers panel showing the new shape layer](images/2022-draw-custom-shapes-layers-panel-heart-shape-c8a9c188.png)
*The Layers panel showing the new shape layer.*
...
![Double-clicking the shape layer thumbnail in the Layers panel](images/2022-draw-custom-shapes-double-click-shape-thumbnail-cc2626df.png)
...
![Choosing a new fill color for the shape from the Color Picker.](images/2022-draw-custom-shapes-choose-red-from-color-picker-49f8527b.jpg)
*Choosing a new fill color for the shape from the Color Picker.*

And Photoshop fills the shape with the new color.

![The shape's fill color has been changed.](images/2022-draw-custom-shapes-custom-shape-new-fill-color-9f46142f.png)
...
![Choosing a shape from the Custom Shape Picker in Photoshop](images/2022-draw-custom-shapes-fill-color-swatch-properties-panel-411b5dd4.png)
...
![The fill color options in the Properties panel](images/2022-draw-custom-shapes-fill-color-options-properties-panel-0a2d24ea.png)
*The fill color options.*

To change the stroke, click the **Stroke** color swatch in the Properties panel.

![Clicking the Stroke color swatch in the Properties panel](images/2022-draw-custom-shapes-stroke-color-swatch-properties-panel-546c621e.png)
...
![Choosing No Color for the stroke.](images/2022-draw-custom-shapes-choose-no-stroke-color-4906a2ed.png)
...
![More stroke options in the Properties panel.](images/2022-draw-custom-shapes-additional-stroke-options-properties-panel-b7aee109.png)
*Choosing a shape by clicking its thumbnail.*
...
![The Swatches, Gradients and Patterns panels.](images/2022-draw-custom-shapes-swatches-gradients-patterns-panels-10beadd3.png)
...
![Clicking on a preset to set it as the shape's fill color](images/2022-draw-custom-shapes-choose-shape-color-from-swatches-panel-1cbfef16.png)
*Clicking on a preset to select it.*

And because my shape layer was active, the shape is instantly filled with the new color.

![The shape is filled with the preset color.](images/2022-draw-custom-shapes-shape-filled-with-color-swatch-preset-4037e360.png)
...
![Selecting the Background layer in the Layers panel](images/2022-draw-custom-shapes-select-background-layer-7847b103.png)
...
![Opening a preset group in the Gradients panel](images/2022-draw-custom-shapes-gradients-panel-pinks-presets-4a17e872.png)
*Opening a preset group in the Gradients panel.*

Then I’ll drag one of the gradients from the panel onto the shape.

![Dragging and dropping a preset onto the shape.](images/2022-draw-custom-shapes-drag-gradient-preset-onto-shape-0b0f5efd.png)
*Dragging and dropping a preset onto the shape.*

And the shape is instantly filled with the gradient.

![The custom shape is filled with the gradient preset](images/2022-draw-custom-shapes-custom-shape-filled-with-gradient-d0a8081f.jpg)
...
![Dropping the preset onto the shape selected the shape layer.](images/2022-draw-custom-shapes-shape-layer-automatically-selected-0fd044d0.png)
...
![The shape layer is selected in Photoshop's Layers panel](images/2022-draw-custom-shapes-shape-layer-selected-layers-panel-eaef9f9b.png)
...
![Dragging and dropping a second shape onto the white background](images/2022-draw-custom-shapes-drop-shape-onto-background-ef85806e.jpg)
...
![The new shape layer is added above the Background layer](images/2022-draw-custom-shapes-new-shape-layer-added-above-background-layer-4cda15a2.png)
...
![The new shape does not share the same fil or stroke as the original.](images/2022-draw-custom-shapes-new-shape-behind-original-shape-a0112664.jpg)
...
![Dragging and dropping a new shape form the Shapes panel onto the original shape](images/2022-draw-custom-shapes-drag-shape-onto-original-shape-eca0e162.jpg)
...
![The new shape layer appears above the original in the Layers panel](images/2022-draw-custom-shapes-new-shape-layer-added-above-original-756c0fb1.png)
...
![The new shape shares the same fill and stroke as the original shape.](images/2022-draw-custom-shapes-new-shape-in-front-of-original-e2ec2fde.jpg)
...
![Selecting the Background layer.](images/2022-draw-custom-shapes-select-background-layer-again-1ed8cd78.png)
*Selecting the Background layer.*

Then with the Custom Shape Tool (or any of the shape tools) selected in the toolbar:

![Selecting the Custom Shape Tool from Photoshop's toolbar](images/2022-draw-custom-shapes-reselect-custom-shape-tool-toolbar-8e054fe0.png)
*Selecting the Custom Shape Tool.*

You’ll see the fill and stroke settings that you’re using as the defaults in the Options Bar.

![The Options Bar showing the default fill and stroke for new shapes](images/2022-draw-custom-shapes-custom-fill-stroke-defaults-options-bar-7978722a.png)
...
![Right-click (Win) / Control-click (Mac) on the shape you want to copy.](images/2022-draw-custom-shapes-right-click-top-shape-layer-c8fa1382.png)
*Right-click (Win) / Control-click (Mac) on the shape you want to copy.*

And choose **Copy Shape Attributes** from the menu.

![Choosing Copy Shape Attributes](images/2022-draw-custom-shapes-copy-shape-attributes-07c884fd.png)
*Choosing Copy Shape Attributes.*

Then I’ll **right-click** (Win) / **Control-click** (Mac) on the shape layer where I want to paste them:

![Right-click (Win) / Control-click (Mac) on the other shape.](images/2022-draw-custom-shapes-right-click-shape-layer-to-paste-9bd73189.png)
*Right-click (Win) / Control-click (Mac) on the other shape.*

And choose **Paste Shape Attributes** from the menu.

![Choosing Paste Shape Attributes.](images/2022-draw-custom-shapes-paste-shape-attributes-05a18997.png)
*Choosing Paste Shape Attributes.*

All three shapes now share the same fill and stroke.

![The fill and stroke are applied to the other shape.](images/2022-draw-custom-shapes-all-shapes-share-same-fill-and-stroke-bab29522.jpg)
...
![Selecting the Path Selection Tool.](images/2022-draw-custom-shapes-select-path-selection-tool-photoshop-d0a2195e.png)
*Selecting the Path Selection Tool.*

Then in the Options Bar, change the **Select** option from Active Layers to **All Layers**.

![Setting Select to All Layers.](images/2022-draw-custom-shapes-select-all-layers-option-63ebf1aa.png)
...
![Selecting a shape by clicking on it with the Path Selection Tool.](images/2022-draw-custom-shapes-click-to-select-shape-c99c7a3c.jpg)
...
![Selecting multiple shapes at once with the Path Selection Tool](images/2022-draw-custom-shapes-select-multiple-shapes-at-once-b5653b9b.jpg)
*Hold Shift and click to select multiple shapes.*

The Layers panel also shows both shape layers selected.

![Photoshop's Layers panel showing the selected shape layers.](images/2022-draw-custom-shapes-two-shape-layers-selected-in-layers-panel-265463de.png)
...
![Choosing a shape from the Custom Shape Picker in Photoshop](images/2022-draw-custom-shapes-change-fill-stroke-in-properties-panel-e23161e6.png)
...
![The fill and stroke are changed for all selected shapes.](images/2022-draw-custom-shapes-editing-all-selected-shapes-photoshop-8256c456.jpg)
...
![Changing the line type and alignment of the stroke.](images/2022-draw-custom-shapes-change-stroke-type-to-dotted-line-ba23cbbe.png)
*Changing the line type and alignment of the stroke.*

Again the change is applied to both shapes.

![The stroke options are applied to both shapes.](images/2022-draw-custom-shapes-changing-stroke-type-alignment-both-shapes-697431d7.jpg)
*The stroke options are applied to both shapes.*

And if I set the stroke back to No Color:

![Setting the stroke to No Color.](images/2022-draw-custom-shapes-set-stroke-to-no-color-both-shapes-0ac6354c.png)
*Removing the stroke.*
...
![The stroke is removed from both shapes.](images/2022-draw-custom-shapes-remove-stroke-around-both-shapes-da2dc408.jpg)
...
![Changing the width of each blue shape in the Properties panel.](images/2022-draw-custom-shapes-resize-shape-width-400px-4ce30144.png)
...
![Dragging the resized shapes into place.](images/2022-draw-custom-shapes-move-shapes-after-resizing-c0c21094.jpg)
...
![shapes](images/2022-draw-custom-shapes-select-both-blue-shapes-8bf1cd56.jpg)
...
![The two smaller shapes have been deleted.](images/2022-draw-custom-shapes-multiple-shapes-deleted-92f2a56d.jpg)
...
![Holding Shift, then dragging and dropping a shape onto the existing shape.](images/2022-draw-custom-shapes-draw-shape-on-existing-shape-layer-46e07ebd.jpg)
...
![The new shape is added to the document.](images/2022-draw-custom-shapes-new-shape-drawn-on-same-layer-57826b88.jpg)
...
![Both shapes are on the same layer.](images/2022-draw-custom-shapes-two-shapes-on-same-layer-0bcb90f1.png)
...
![The two combined shapes share the same gradient fill.](images/2022-draw-custom-shapes-combined-shapes-share-same-fill-80cf3e12.jpg)
...
![The stroke appears around the combined shapes.](images/2022-draw-custom-shapes-combined-shapes-share-same-stroke-9038e37e.jpg)
...
![Combined shapes can still be selected on their own.](images/2022-draw-custom-shapes-select-individual-shapes-on-same-layer-eaf76c50.jpg)
...
![Resizing and rotating one of the combined shapes.](images/2022-draw-custom-shapes-resize-rotate-selected-shape-f2d4303c.jpg)
...
![Resizing and centering the butterfly shape inside the heart shape.](images/2022-draw-custom-shapes-center-and-resize-shape-in-another-c0f557a8.jpg)
...
![Selecting both shapes at once.](images/2022-draw-custom-shapes-deselect-heart-shape-2ce5f5c7.jpg)
...
![Choosing Align Horizontal Centers from the Path Alignment options.](images/2022-draw-custom-shapes-click-align-horizontal-centers-0f60cf10.png)
...
![Deselecting the heart shape.](images/2022-draw-custom-shapes-deselect-heart-shape-2ce5f5c7.jpg)
...
![Clicking the Path Operations icon.](images/2022-draw-custom-shapes-click-path-operations-icon-b8266754.png)
*Clicking the Path Operations icon.*

And I’ll choose **Subtract Front Shape**:

![Choosing the Subtract Front Shape command.](images/2022-draw-custom-shapes-choose-subtract-front-shape-4e3b0535.png)
...
![The result after subtracting the front shape.](images/2022-draw-custom-shapes-how-to-subtract-one-shape-from-another-6c2322bf.jpg)
...
![Turning off the Background layer.](images/2022-draw-custom-shapes-click-backgound-layer-visibility-icon-58e89210.png)
...
![Turning off the Background layer reveals the transparency through the shape.](images/2022-draw-custom-shapes-transparency-through-shape-378aa8a3.jpg)
...
![The heart shape moves but the butterfly does not.](images/2022-draw-custom-shapes-drag-one-shape-without-the-other-db3cf6ed.jpg)
...
![The heart shape resizes but the butterfly does not.](images/2022-draw-custom-shapes-resize-one-shape-without-the-other-edd7e30b.jpg)
...
![Dragging around all the shapes with the Path Selection Tool to select them.](images/2022-draw-custom-shapes-dragging-to-select-shapes-0535cd64.jpg)
...
![Choosing Merge Shape Components from the Path Operations menu.](images/2022-draw-custom-shapes-merge-shape-components-02f4ba3f.png)
...
![Photoshop warns that merging the shapes will result in a regular path.](images/2022-draw-custom-shapes-live-shape-warning-fcc7727c.png)
...
![The result after merging the two shapes together.](images/2022-draw-custom-shapes-reposition-merged-shape-bc3513f9.jpg)
...
![A merged shape's properties can be edited from the Options Bar.](images/2022-draw-custom-shapes-fill-stroke-options-for-merged-shape-0af2f8ca.png)
...
![The stroke appears around the entire shape, inside and out.](images/2022-draw-custom-shapes-stroke-added-to-merged-shape-22605104.jpg)
...
![The width and height of a merged shape can be set in the Options Bar.](images/2022-draw-custom-shapes-merged-shape-width-height-options-bar-5b8ddcaa.png)
...
![Choosing the Free Transform command from the Edit menu in Photoshop](images/2022-draw-custom-shapes-edit-free-transform-89496b98.png)
...
![Resizing the merged shape using the Free Transform command](images/2022-draw-custom-shapes-resize-merged-shape-free-transform-a52c8152.jpg)
...
![Clicking the checkmark to close Free Transform](images/2022-draw-custom-shapes-free-transform-checkmark-84e31a28.png)
*Clicking the checkmark.*
...
![Selecting the bottom group in the Shapes panel.](images/2022-draw-custom-shapes-select-legacy-shapes-and-more-group-70beb868.png)
*Selecting the bottom group in the Shapes panel.*

Then click the **New Group** icon.

![Clicking the New Group icon in the Shapes panel.](images/2022-draw-custom-shapes-new-shape-group-icon-9e270137.png)
*Clicking the New Group icon.*

Name the group. I’ll name it <q>My Shapes</q>. Then click OK.

![Naming the new shape group.](images/2022-draw-custom-shapes-naming-new-shape-group-db5d71e5.png)
...
![The new shape group appears.](images/2022-draw-custom-shapes-my-shapes-group-c28d3008.png)
...
![Selecting the merged shape in the Photoshop document.](images/2022-draw-custom-shapes-select-merged-shape-a1ec2dae.jpg)
*Selecting the shape.*
...
![Choosing the Define Custom Shape command under the Edit menu in Photoshop](images/2022-draw-custom-shapes-define-custom-shape-command-91b43d05.png)
*Going to Edit > Define Custom Shape.*

Name the shape. I’ll name mine <q>Heart with Butterfly</q>. Then click OK.

![Naming the new shape preset.](images/2022-draw-custom-shapes-name-custom-shape-bd0ebee1.png)
...
![The new shape preset appears in the Shapes panel.](images/2022-draw-custom-shapes-new-custom-shape-preset-saved-5d8abd9e.png)
